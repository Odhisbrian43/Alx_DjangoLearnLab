...
urlpatterns = [
    ...
    path('post/<int:pk>/edit/', view=views.PostUpdateView, name=('post editing')),
    ...
    path('post/<int:post_id>/comments/<int:pk>/edit/', view=views.CommentUpdateView, name=('edit comment')),
